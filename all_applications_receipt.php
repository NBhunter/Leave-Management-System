			...
			<div class="card-body">
				<table class="table table-bordered">
					...
					<tbody>
						...
						$qry = $conn->query("SELECT ll.*,concat(e.firstname,', ',e.middlename,' ',e.lastname) as name,e.employee_id as eID FROM leave_list ll inner join employee_details e on e.id = ll.employee_id where ll.type BETWEEN 4 AND 6 ");
